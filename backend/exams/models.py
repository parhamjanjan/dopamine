...
class ExamAttempt(models.Model):
    ...
    # درصد رسمی با نمره منفی
    #
    # اگر آزمون چند دفترچه داشته باشد،
    # این مقدار درصد کل ضریب‌دار آزمون است.
    ...
    # درصد خام ضریب‌دار بدون نمره منفی
...
class ExamResult(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["exam", "is_final"]
            ),
            models.Index(
                fields=["user", "exam"]
            ),
            models.Index(
                fields=["exam", "national_rank"]
            ),
            models.Index(
                fields=["exam", "provincial_rank"]
            ),
        ]
...
class ExamBookletResult(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["booklet", "score"]
            ),
            models.Index(
                fields=["booklet", "national_rank"]
            ),
            models.Index(
                fields=["booklet", "provincial_rank"]
            ),
        ]
